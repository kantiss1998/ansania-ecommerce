...
export interface CmsSettingAttributes {
    ...
    setting_type: 'text' | 'textarea' | 'longtext' | 'image' | 'boolean' | 'json' | 'number' | 'color';
...
> {
    ...
    declare setting_type: CreationOptional<'text' | 'textarea' | 'longtext' | 'image' | 'boolean' | 'json' | 'number' | 'color'>;
