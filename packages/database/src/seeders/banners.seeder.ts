...
const banners = [
    {
        ...
        description: 'Tampil anggun dan menawan di hari raya dengan koleksi terbaru kami.',
        image_url: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?auto=format&fit=crop&q=80',
    ...
    },
    {
        ...
        image_url: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80',
...
export default {
    async up(queryInterface: QueryInterface): Promise<void> {
        ...
        try {
            await queryInterface.bulkInsert('cms_banners', banners.map(b => ({
                ...b,
                created_at: now,
                updated_at: now,
            })));
