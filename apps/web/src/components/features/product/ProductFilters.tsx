  ...
  return (
    <div className="space-y-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      {availableColors.length > 0 && (
        <div>
          <h4 className="mb-3 text-sm font-bold text-gray-900">Warna</h4>
      ...
      {availableSizes.length > 0 && (
        <div>
          <h4 className="mb-3 text-sm font-bold text-gray-900">Ukuran</h4>
          <div className="flex flex-wrap gap-2">
      ...
      {availableFinishings.length > 0 && (
        <div>
          <h4 className="mb-3 text-sm font-bold text-gray-900">Finishing</h4>
          <div className="flex flex-wrap gap-2">
            {availableFinishings.map((finishing) => (
              <button
                ...
                className={`rounded-xl border-2 px-3 py-2 text-sm font-semibold transition-all ${
                  selectedFinishings.includes(finishing)
                    ? "border-primary-600 bg-gradient-primary text-white shadow-md shadow-primary-500/30 scale-105"
                    : "border-gray-200 bg-white text-gray-700 hover:border-primary-300 hover:bg-primary-50"
                }`}
              >
      ...
      {/* Stock Status */}
      <div>
        <h4 className="mb-3 text-sm font-bold text-gray-900">Ketersediaan</h4>
        <select
          value={stockStatus}
