      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="absolute left-3 top-3 flex flex-col gap-2 z-10 pointer-events-none">
          {product.is_new && (
            <Badge
              variant="info"
              className="shadow-lg backdrop-blur-sm bg-gradient-to-r from-blue-500 to-cyan-500 text-white border-none px-3 py-1.5 rounded-xl font-bold"
            >
              Baru
            </Badge>
          )}
          {product.is_featured && (
            <Badge
              variant="warning"
              className="shadow-lg backdrop-blur-sm bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-none px-3 py-1.5 rounded-xl font-bold"
            >
              Featured
            </Badge>
          )}
          {discountPercentage > 0 && (
            <Badge
              variant="error"
              className="shadow-lg backdrop-blur-sm bg-gradient-to-r from-red-500 to-pink-500 text-white border-none px-3 py-1.5 rounded-xl font-bold"
            >
              -{discountPercentage}%
            </Badge>
          )}
