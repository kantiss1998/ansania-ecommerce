    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEdit && initialData) {
                ...
                await adminCmsService.createPage(payload as any);
            }
            ...
            <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div>
                    <h2 className="text-xl font-bold text-gray-900">
                        {isEdit ? `Edit Halaman: ${initialData.title}` : 'Buat Halaman Baru'}
                    </h2>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                <div className="lg:col-span-2 space-y-6">
                    <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm space-y-6">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-semibold text-gray-700">Konten (Markdown/HTML Support)</label>
                            <textarea
                ...
                <div className="space-y-6">
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-4">
                            ...
                            />
                            <label htmlFor="is_published" className="text-sm font-medium text-gray-700">Terbitkan Segera</label>
                        </div>
                    </div>

                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
                        <h3 className="font-semibold text-gray-900 border-b pb-2">SEO Metadata</h3>
                        <p className="text-xs text-gray-500 italic">Fitur optimasi mesin pencari akan segera hadir.</p>
                    </div>
                </div>
            </div>
        </form>
