...
import { Voucher } from "@repo/shared";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const dataToSubmit = {
        ...
        discount_type: formData.discount_type as Voucher["discount_type"],
      };
      ...
      if (initialData) {
        ...
        await adminVoucherService.createVoucher(dataToSubmit);
      ...
      console.error(err);
      error(
        initialData ? "Gagal memperbarui voucher" : "Gagal membuat voucher",
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    discount_type: e.target.value as Voucher["discount_type"],
                  })
                }
              >
        ...
        <div className="space-y-4">
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, usage_limit: Number(e.target.value) })
            }
