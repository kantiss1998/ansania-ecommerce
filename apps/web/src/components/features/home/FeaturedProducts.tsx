        ...
        <section className="py-16">
            ...
            <div className="mb-12 text-center">
                ...
                >
                    ...
                    <span className="text-sm font-semibold text-primary-700">Pilihan Terbaik</span>
                </motion.div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                                {/* Tag */}
                                {tag && (
                                    <span className={`absolute left-3 top-3 z-10 rounded-xl px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-white shadow-lg backdrop-blur-sm ${tagColor}`}>
                                        {tag}
                                    </span>
                                )}
                                ...
                                <div className="h-full w-full">
                                    <Image
                                        src={product.thumbnail_url || product.images?.[0]?.image_url || '/placeholder.jpg'}
                                        alt={product.name}
                                        fill
                            ...
                            <div className="flex flex-1 flex-col p-5">
                                ...
                                <div className="mb-4 flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-medium text-gray-400">({product.rating_average ? product.rating_average.toFixed(1) : '0.0'})</span>
                                </div>
