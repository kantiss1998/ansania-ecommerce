...
import { ShoppingBag, ArrowRight, Sparkles, Star, ChevronRight, Layers, Heart, ShieldCheck } from 'lucide-react';
        ...
        <div className="space-y-24 pb-20">
                ...
                <div className="container relative z-10 mx-auto px-8 md:px-16 grid lg:grid-cols-2 gap-12 items-center text-left">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full px-4 py-2">
                            ...
                            <span className="text-sm font-medium text-primary-100 uppercase tracking-widest">Koleksi Ramadhan 2026</span>
                        </div>
                        ...
                        <p className="text-xl text-gray-400 max-w-lg leading-relaxed font-light">
                            Temukan koleksi eksklusif Ansania yang dirancang khusus untuk kenyamanan dan keanggunan gaya modern Anda.
                        </p>

                        <div className="flex flex-wrap gap-5 pt-4">
                            <Button size="lg" className="h-16 px-10 rounded-full bg-primary-600 hover:bg-primary-500 text-lg font-semibold shadow-xl shadow-primary-900/20 group">
                                Belanja Sekarang
                                <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                            </Button>
                            <Button size="lg" variant="outline" className="h-16 px-10 rounded-full border-white/10 text-white hover:bg-white/5 text-lg font-semibold backdrop-blur-sm">
                                Lihat Lookbook
                            </Button>
                        </div>
                    </motion.div>
                    ...
                    >
                            ...
                            <div className="aspect-[4/5] bg-neutral-800 rounded-[1.8rem] flex items-center justify-center relative overflow-hidden group">
                                ...
                                <div className="absolute bottom-10 left-10 right-10">
                                    <div className="p-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl">
                                        <p className="text-white font-semibold text-lg">Signature Series</p>
                                        <p className="text-white/60 text-sm">Edisi Terbatas • Tersedia Sekarang</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <span className="text-xs font-bold uppercase tracking-tighter">Diskon</span>
            ...
            <section className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6 text-left">
                    <div className="space-y-4">
                        <h2 className="text-4xl font-bold font-heading text-gray-900">Kategori Populer</h2>
                        <p className="text-gray-500 max-w-md">Jelajahi berbagai pilihan koleksi terbaik kami yang sesuai dengan kebutuhan gaya Anda.</p>
                    </div>
                    <Link href="/categories" className="group inline-flex items-center text-primary-600 font-semibold hover:text-primary-700 transition-colors">
                ...
                >
                    {[
                        { name: 'Hijab Voice', icon: Sparkles, count: '120+ Produk', color: 'bg-rose-50' },
                        { name: 'Gamis Premium', icon: Layers, count: '85+ Produk', color: 'bg-blue-50' },
                        { name: 'Mukena Series', icon: Heart, count: '40+ Produk', color: 'bg-amber-50' },
                        { name: 'Accessories', icon: ShoppingBag, count: '60+ Produk', color: 'bg-emerald-50' },
                    ].map((cat, i) => (
                        <motion.div
                        ...
                        >
                            <div className={`aspect-square rounded-[2rem] ${cat.color} flex flex-col items-center justify-center p-8 transition-shadow hover:shadow-xl hover:shadow-primary-500/10 border border-transparent hover:border-primary-100`}>
            ...
            <section className="bg-gray-50 py-24 -mx-4 px-4 overflow-hidden text-center">
                <div className="container mx-auto">
                    <div className="mb-16 space-y-4">
                        <div className="inline-block px-4 py-1.5 bg-primary-50 rounded-full text-primary-600 text-xs font-bold uppercase tracking-widest">Terbaru</div>
                        <h2 className="text-5xl font-bold font-heading text-gray-900 italic">Koleksi Teranyar</h2>
                        <p className="text-gray-500 max-w-2xl mx-auto italic">Desain eksklusif yang memadukan tren terkini dengan sentuhan klasik yang abadi.</p>
                    </div>
                            ...
                            >
                                ...
                                <div className="mt-6 space-y-2 px-2">
                                    <div className="flex justify-between items-start text-left">
                                        <h3 className="font-bold text-lg text-gray-900 group-hover:text-primary-700 transition-colors italic">Premium Silk Scarf {item}</h3>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className="text-xl font-black text-primary-700">Rp 149.000</span>
                                        <span className="text-sm text-gray-400 line-through">Rp 199.000</span>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
                    ...
                    <div className="mt-16 text-center">
                        <Button variant="outline" size="lg" className="rounded-full px-12 border-2 border-primary-100 hover:border-primary-600 hover:bg-primary-50 text-gray-900 font-bold transition-all h-14">
            ...
            <section className="container mx-auto px-4 py-12">
                <div className="grid md:grid-cols-3 gap-12 text-left">
                    {[
                        { title: 'Material Premium', desc: 'Kami hanya menggunakan bahan kualitas terbaik untuk kenyamanan Anda.', icon: ShieldCheck },
                        { title: 'Pengiriman Seluruh Dunia', desc: 'Layanan pengiriman terpercaya hingga ke depan pintu rumah Anda.', icon: ShoppingBag },
                        { title: 'Dukungan 24/7', desc: 'Tim kami siap membantu Anda kapan saja untuk pengalaman belanja terbaik.', icon: Sparkles },
                    ].map((item, i) => (
