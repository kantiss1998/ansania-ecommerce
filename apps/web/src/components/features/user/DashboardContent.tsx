    ...
    const fetchDashboardData = async () => {
      try {
        ...
        setStats({
          ...
          pendingPayment: allOrders.filter(
            (o) => o.status === ORDER_STATUS.PENDING_PAYMENT,
          ).length,
        ...
        {statsCards.map((stat, index) => (
          ...
          >
            ...
            <div className="relative">
              <div
                className={`inline-flex rounded-xl bg-gradient-to-br ${stat.iconBg} p-3 shadow-md`}
              >
                <stat.icon
              ...
              <div className="mt-4">
                ...
                <p
                  className={`mt-2 text-3xl font-bold bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent`}
                >
                  {stat.value}
                </p>
              </div>
          ...
          {quickActions.map((action, index) => (
            <Link key={action.title} href={action.href}>
              ...
              >
                ...
                <div className="relative">
                  <div
                    className={`inline-flex rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 p-3 group-hover:scale-110 transition-transform`}
                  >
