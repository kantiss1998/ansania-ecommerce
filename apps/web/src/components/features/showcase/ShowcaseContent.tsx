        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50/20 py-12">
            <div className="container mx-auto px-4">
                ...
                <div className="space-y-16">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        ...
                                        <Button variant="outline" leftIcon={Heart} rightIcon={Check}>
                                            Save to Wishlist
                                        </Button>
                            ...
                            <Tabs defaultValue="overview">
                                ...
                                <TabsContent value="overview">
                                    <p className="text-gray-600">
                                        This is the overview tab content. Tabs support multiple variants including default, pills, and underline styles.
                                    </p>
                                </TabsContent>

                                <TabsContent value="specs">
                                    <p className="text-gray-600">
                                        Specifications content goes here. Each tab content animates smoothly when switching.
                                    </p>
                                </TabsContent>
                        ...
                        <Card padding="lg">
                            <Accordion type="single" collapsible>
                                <AccordionItem value="item1">
                                    ...
                                    <AccordionContent>
                                        We offer a 7-day free return policy on all products. Items must be in original condition with tags attached.
                                    </AccordionContent>
                                </AccordionItem>
                    ...
                    {/* Combined Example */}
                    <section>
                        <h2 className="text-3xl font-bold mb-6">Combined Example: Login Form</h2>
