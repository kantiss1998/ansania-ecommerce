...
type CardVariant = 'default' | 'glass' | 'gradient-border' | 'elevated' | 'flat';
...
export function Card({
    ...
    const variantStyles = {
        ...
        'gradient-border': 'bg-white relative overflow-hidden before:absolute before:inset-0 before:p-[2px] before:rounded-2xl before:bg-gradient-primary before:-z-10',
    ...
    return (
        ...
        >
            <Image
                ...
                alt={alt}
                fill
                className="object-cover transition-transform duration-slow hover:scale-110"
            />
        </div>
    );
}
