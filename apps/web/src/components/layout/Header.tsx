        ...
        >
            ...
            {!scrolled && (
                <div className="bg-gradient-primary text-white py-2 text-center text-sm animate-fade-in">
                    <div className="container mx-auto px-4 flex items-center justify-center gap-2">
                        ...
                        <span className="font-medium">Gratis Ongkir untuk pembelian di atas Rp 1.000.000</span>
                    </div>
                </div>
            )}
            ...
            <div className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-4 hidden flex-1 md:block max-w-sm lg:max-w-md">
                    <Suspense fallback={<div className="h-10 w-full rounded-full bg-gray-100 animate-pulse" />}>
                        <SearchBar />
                    </Suspense>
                </div>
