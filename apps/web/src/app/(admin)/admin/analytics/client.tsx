...
interface AnalyticsAbandonedCarts {
  count: number | string;
...
interface AdminAnalyticsClientProps {
  initialData: {
    views: AnalyticsViews | null;
    conversion: AnalyticsConversion | null;
    abandonedCarts: AnalyticsAbandonedCarts | null;
  } | null;
}
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Pantau traffic pengunjung, tingkat konversi, dan efektivitas funnel
            belanja
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-4">
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-1 text-[10px] text-success-600 font-medium">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-2xl font-bold text-gray-900">
            {conversion?.rate ? `${conversion.rate}%` : "0%"}
          </p>
          <div className="mt-1 text-[10px] text-error-600 font-medium">
            ↓ 0.8% dari target
          </div>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-1 text-[10px] text-warning-600 font-medium">
            {abandonedCarts?.total_value_formatted || "Rp 0"} potensi hilang
          </div>
        </div>
      </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm flex flex-col lg:col-span-2">
          ...
          <div className="p-8 flex-1 flex items-center justify-center">
            ...
            <div className="w-full h-64 bg-gray-50 rounded-lg flex items-center justify-center border border-dashed border-gray-200 relative overflow-hidden">
              ...
              <span className="relative z-10 text-xs text-gray-400 font-medium italic">
                Trend Pengunjung 30 Hari Terakhir
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="mt-8">
              <Link href="/admin/analytics/search-history">
                <Button
                  variant="ghost"
                  size="sm"
                  className="w-full text-secondary-600 border border-secondary-100 hover:bg-secondary-50"
                >
      ...
      <div className="flex flex-wrap gap-4">
        <Link
          ...
          className="px-5 py-3 rounded-xl bg-white border border-gray-200 hover:shadow-sm transition-all text-sm font-medium text-gray-700"
        >
          Views by Product
        </Link>
        <Link
        ...
        <Link
          href="/admin/analytics/revenue-by-category"
          className="px-5 py-3 rounded-xl bg-white border border-gray-200 hover:shadow-sm transition-all text-sm font-medium text-gray-700"
        >
