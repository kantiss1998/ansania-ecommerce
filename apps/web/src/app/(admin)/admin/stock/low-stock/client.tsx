...
export default function AdminLowStockClient() {
    ...
    const fetchLowStock = async () => {
        setIsLoading(true);
        try {
            const response = await apiClient.get<{ data: { items: StockItem[] } }>('/admin/stock/low-stock');
            ...
            <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Produk dengan stok menipis yang perlu segera diisi ulang
                    </p>
                </div>
                                ...
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell>
                                        <div className="text-sm text-gray-600">
                                            ...
                                            {!item.color && !item.size && <span className="text-gray-400">-</span>}
                                        </div>
                                    </TableCell>
                                    <TableCell>
