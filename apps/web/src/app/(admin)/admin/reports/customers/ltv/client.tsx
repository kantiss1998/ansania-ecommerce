        ...
        <div className="space-y-6">
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-semibold text-gray-900">Customer Lifetime Value (LTV)</h2>
                    ...
                    <TableBody>
                        {customers.length > 0 ? (
                            customers.map((customer) => {
                                const ltvPerDay = customer.customer_age_days > 0
                                ...
                                return (
                                    <TableRow key={customer.user_id}>
                                        ...
                                        <TableCell className="text-sm text-gray-600">
                                            Rp {ltvPerDay.toLocaleString('id-ID', { maximumFractionDigits: 0 })}
                                        </TableCell>
                                        <TableCell>
