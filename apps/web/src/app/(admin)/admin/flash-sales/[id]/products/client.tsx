...
export default function AdminFlashSaleProductsClient({ flashSaleId }: AdminFlashSaleProductsClientProps) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div>
                    <h2 className="text-xl font-semibold text-gray-900">Flash Sale Products</h2>
            ...
            {showAddForm && (
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Tambah Produk ke Flash Sale</h3>
                    <form onSubmit={handleAddProduct} className="space-y-4">
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Stock Limit</label>
                                <input
                                    type="number"
                                    required
                                    min="1"
                    ...
                    <TableBody>
                        {products.length > 0 ? (
                            products.map((item) => {
                                ...
                                const discountedPrice = normalPrice * (1 - item.discount_percentage / 100);
