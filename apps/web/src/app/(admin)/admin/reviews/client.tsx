...
function AdminReviewsContent({ initialData }: AdminReviewsClientProps) {
    ...
    const handleModeration = async (id: number, action: 'approve' | 'reject' | 'delete') => {
        try {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                <div>
                    <h2 className="text-xl font-semibold text-gray-900">Ulasan & Rating</h2>
                                ...
                                <TableRow key={review.id}>
                                    <TableCell className="max-w-[180px]">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="font-medium text-gray-900 truncate" title={review.product?.name}>
                                    ...
                                    <TableCell className="max-w-xs">
                                        ...
                                        <p className="mt-1 text-sm text-gray-600 line-clamp-2" title={review.comment}>
                                            {review.comment}
                                        </p>
                                    </TableCell>
                                    <TableCell>
...
export default function AdminReviewsClient({ initialData }: AdminReviewsClientProps) {
    return (
        <Suspense fallback={<div className="p-8 text-center text-gray-500">Memuat ulasan...</div>}>
