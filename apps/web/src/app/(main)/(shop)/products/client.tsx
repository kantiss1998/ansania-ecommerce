            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-50 to-purple-50 rounded-full px-4 py-2 mb-4">
                        ...
                        <span className="text-sm font-semibold text-primary-700">Koleksi Produk</span>
                    </div>
                        ...
                        <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-2xl border border-gray-200 bg-white shadow-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-sm font-semibold text-gray-900">
                                    {pagination.total > 0 ? (
                                        <>
                                            Menampilkan <span className="bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">{products?.length || 0}</span> dari <span className="bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">{pagination.total}</span> produk
                                        </>
                                    ) : (
                                        'Tidak ada produk'
                                    )}
                        ...
                        {loading ? (
                            <div className="flex h-64 items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="mt-4 text-sm font-medium text-gray-600">Memuat produk...</p>
                                </div>
                            </div>
                        ) : (
