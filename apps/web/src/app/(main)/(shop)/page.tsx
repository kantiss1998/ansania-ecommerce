...
export default async function HomePage() {
    ...
    const featuredProductsPromise = productService.getProducts({ isFeatured: true, limit: 8 });
    ...
    const flashSaleProducts = activeFlashSale?.products.map(item => ({
        ...
        thumbnail_url: item.product.thumbnail_url || item.product.images?.[0]?.image_url
    })) || [];
                    ...
                    <section className="mt-20 mb-12 relative">
                        ...
                        <div className="relative flex flex-col items-center justify-center gap-8 border-t border-gray-100 pt-16 pb-8">
                            ...
                            <div className="inline-flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-sm border border-gray-100">
                                ...
                                <span className="text-sm font-semibold text-gray-700">Terhubung dengan Kami</span>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-600">Dapatkan inspirasi dan update terbaru dari kami</p>
                            </div>
                            ...
                            <div className="flex gap-6">
                                ...
                                {siteSettings.socialLinks.facebook && (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold text-gray-700 group-hover:text-blue-600 transition-colors">Facebook</span>
                                    </a>
                                )}
                                {siteSettings.socialLinks.whatsapp && (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold text-gray-700 group-hover:text-green-600 transition-colors">WhatsApp</span>
                                    </a>
                                )}
                            </div>
                        </div>
