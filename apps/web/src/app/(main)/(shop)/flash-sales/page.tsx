      ...
      <div className="container mx-auto px-4">
        <div className="mb-12 rounded-3xl bg-gradient-to-br from-error-600 to-primary-900 p-8 text-white md:p-16 shadow-2xl relative overflow-hidden">
          <div className="relative z-10 max-w-2xl">
            <Badge
              variant="error"
              className="bg-white text-error-600 mb-4 animate-pulse"
            >
              Sedang Berlangsung
            </Badge>
            ...
            <p className="mt-6 text-xl text-primary-100/90 font-medium">
              Dapatkan penawaran terbatas dengan harga terbaik untuk furnitur
              pilihan. Jangan sampai kehabisan!
            </p>
          </div>
          {/* Decorative element */}
        ...
        <div className="space-y-12">
          {flashSales.length > 0 ? (
            flashSales.map((sale) => (
              <section
                key={sale.id}
                className="rounded-3xl bg-white p-8 shadow-sm border border-gray-100 overflow-hidden"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 border-b border-gray-100 pb-6">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="text-sm font-bold text-error-600 bg-error-50 px-4 py-2 rounded-full uppercase tracking-widest">
                      Berakhir Pada:
                    </div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                  {(sale.products || []).map((item) => {
                    // Skip if product relation is missing
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-col p-5">
                          <h3 className="line-clamp-2 text-sm font-bold text-gray-900 group-hover:text-primary-600 transition-colors">
                            {item.product.name}
                          </h3>
            ...
            <div className="py-24 text-center rounded-3xl border-2 border-dashed border-gray-200 bg-white">
              ...
              <p className="mt-2 text-gray-500">
                Nantikan penawaran menarik kami selanjutnya!
              </p>
              <Link href="/products">
