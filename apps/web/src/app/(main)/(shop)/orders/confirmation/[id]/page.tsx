                ...
                <div className="relative overflow-hidden rounded-2xl border-2 border-warning-200 bg-gradient-to-br from-warning-50 to-orange-50 p-6 shadow-lg">
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-warning-800 bg-clip-text text-transparent">
                        Selesaikan Pembayaran
                      </h3>
                      <p className="mt-1 text-sm text-gray-600">
                        Mohon lakukan pembayaran sebelum batas waktu berakhir
                      ...
                      <div className="mt-4 flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-warning-600/80">
                          Sisa Waktu
                        </span>
                      </div>
                    </div>
                ...
                <div className="rounded-2xl border-2 border-gray-100 bg-white p-8 shadow-lg">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b-2 border-gray-100 pb-6">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-mono text-xl font-bold bg-gradient-to-r from-gray-900 to-primary-700 bg-clip-text text-transparent px-4 py-2 rounded-xl border-2 border-gray-200 bg-gray-50">
                          {vaNumber}
                        </span>
                        <button
                  ...
                  <div className="mt-8 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 p-6 border border-blue-100">
                    ...
                    <ol className="space-y-3 text-sm text-blue-800 list-decimal list-inside">
                      ...
                      <li>
                        Pilih menu <strong>m-Transfer</strong> atau{" "}
            ...
            <div className="sticky top-24 space-y-6">
              <div className="rounded-2xl border-2 border-gray-100 bg-white p-6 shadow-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                    Ringkasan Pesanan
                  </h3>
                </div>
                <div className="space-y-4 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
                  {order.items?.map((item, index) => (
                    ...
                    >
                      <div className="relative h-16 w-16 shrink-0 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                        <Image
