            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-50 to-purple-50 rounded-full px-4 py-2 mb-4">
                        ...
                        <span className="text-sm font-semibold text-primary-700">Dashboard Akun</span>
                    </div>
                    ...
                    {user && (
                        <p className="mt-2 text-gray-600">
                            Selamat datang kembali, <span className="font-semibold bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">{user.full_name}</span>
                        </p>
                    )}
                </div>
