...
export async function createBanner(
  data: Partial<CmsBanner>,
): Promise<CmsBanner> {
  return CmsBanner.create(data as unknown as CmsBanner);
}
...
export async function createPage(data: Partial<CmsPage>): Promise<CmsPage> {
  return CmsPage.create(data as unknown as CmsPage);
}
