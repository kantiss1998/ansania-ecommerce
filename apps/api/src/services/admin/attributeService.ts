...
export async function createColor(
  data: Partial<FilterColor>,
): Promise<FilterColor> {
  return FilterColor.create(data as unknown as FilterColor);
}
...
export async function createSize(
  data: Partial<FilterSize>,
): Promise<FilterSize> {
  return FilterSize.create(data as unknown as FilterSize);
}
...
export async function createFinishing(
  data: Partial<FilterFinishing>,
): Promise<FilterFinishing> {
  return FilterFinishing.create(data as unknown as FilterFinishing);
}
