...
export async function clearFailedEmails(): Promise<{
  success: boolean;
  count: number;
}> {
...
): Promise<{ items: ActivityLog[]; meta: Record<string, unknown> }> {
...
export async function createSystemNotification(
  ...
  return NotificationModel.create(data as unknown as NotificationModel);
}
