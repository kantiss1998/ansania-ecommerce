...
export async function listAdminProducts(query: {
  ...
  const where: Record<string | symbol, unknown> = {}; // Using string | symbol for dynamic construction with Op.or
...
export async function setPrimaryImage(
  ...
  if (!image || image.product_id !== productId)
    throw new NotFoundError("ProductImage");
