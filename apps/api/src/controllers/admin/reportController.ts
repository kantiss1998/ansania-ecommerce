...
export async function getSales(
  ...
  try {
    ...
    const period =
      ...
      "daily";
    const data = await adminReportService.getSalesReport(
      startDate,
      endDate,
      period,
    );
...
export async function getProducts(
  ...
  try {
    ...
    const data = await adminReportService.getProductPerformance(
      startDate,
      endDate,
      limit,
    );
...
export async function getCustomers(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const limit = req.query.limit ? Number(req.query.limit) : 10;
    const data = await adminReportService.getCustomerSpenders(
      startDate,
      endDate,
      limit,
    );
...
export async function getVouchers(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminReportService.getVoucherUsageReport(
      startDate,
      endDate,
    );
...
export async function getGrowth(
  ...
  try {
    ...
    const period =
      (req.query.period as "daily" | "weekly" | "monthly" | "yearly") ||
      "daily";
    const data = await adminReportService.getNewCustomersGrowth(
      startDate,
      endDate,
      period,
    );
...
export async function getWorstProducts(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const limit = req.query.limit ? Number(req.query.limit) : 10;
    const data = await adminReportService.getWorstSellers(
      startDate,
      endDate,
      limit,
    );
...
export async function getNewCustomers(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminReportService.getNewCustomersList(
      startDate,
      endDate,
    );
