...
export async function getProductViews(
  ...
  try {
    ...
    const data = await adminAnalyticsService.getProductViewStats(
      startDate,
      endDate,
    );
...
export async function getSearchHistory(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminAnalyticsService.getSearchAnalytics(
      startDate,
      endDate,
    );
...
export async function getConversion(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminAnalyticsService.getConversionStats(
      startDate,
      endDate,
    );
...
export async function getAbandonedCarts(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminAnalyticsService.getAbandonedCartStats(
      startDate,
      endDate,
    );
...
export async function getRevenueByCategory(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminAnalyticsService.getRevenueByCategory(
      startDate,
      endDate,
    );
...
export async function getRevenueByProduct(
  ...
  try {
    ...
    const data = await adminAnalyticsService.getRevenueByProduct(
      startDate,
      endDate,
      limit,
    );
...
export async function getCustomerBehavior(
  ...
  try {
    const { startDate, endDate } = getDateRange(req.query);
    const data = await adminAnalyticsService.getCustomerBehavior(
      startDate,
      endDate,
    );
