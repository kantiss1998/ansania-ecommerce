...
router.delete('/email-queue/clear-failed', adminSystemController.clearFailedEmails);
...
router.get('/activity-logs/user/:userId', adminSystemController.getActivityLogsByUser);
router.get('/activity-logs/entity/:entityType/:entityId', adminSystemController.getActivityLogsByEntity);
